...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if os.path.isfile(args.transfer_model_path):
        if main_process():
    ...
    model._fix_weight()
     ...
     # Freeze all layers in the pre-trained model except for the last fully connected layer
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.data_name == 'modelnet' or args.data_name == 'scanobjectnn' or args.data_name == 'scanobjectnn_hardest' or args.data_name == 'shapenetpart' :
